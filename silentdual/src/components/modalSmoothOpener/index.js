...
import crossBlack from "../../images/left-arrow-black-glow.png"
...
const ModalSmoothOpenerContainerContent = styled.div`
  ...
  height: 100%;
  opacity: 0;
  padding: ${({background}) => background === "white" ? "130px" : "20px" } 20px 20px;



  @media screen and (min-width: 768px) {
    padding: ${({background}) => background === "white" ? "130px 8.3333% 40px" : "20px" } ;
    box-sizing: border-box;
  }

  @media screen and (orientation:landscape) and (max-width: 767px) {
    padding: ${({background}) => background === "white" ? "130px" : "20px" } 40px 40px;
  }
`
...
const ModalSmoothOpener = ({children, modalContainer, handleModalOpenened, background}) =>  {
  ...
  const openModal = (el) => {
    ...
    tlOpen.set(el, {
          ...
          .to([modalClose.current, modalContent.current] , .4, {
            opacity: 1,
            overflow: "scroll",
            ease: Expo.easeInOut
          })
  ...
  const closeModal = (el) => {
    ...
    tlClose.to([modalClose.current, modalContent.current], .4, {
              opacity: 0,
              overflow: "hidden",
              ease: Expo.easeInOut
            })
  ...
  return (
    <Fragment>
      <ModalButton onClick={() => {!isShowing && toggle(!isShowing)}} />
      ...
      {isShowing && createPortal(
        ...
        {background === "white" ?
          ...
          <ModalSmoothOpenerContainerContent ref={modalContent} background={background}>
            {children}
