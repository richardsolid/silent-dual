...
const SpecFuncionamiento = ({ isResponsive, data }) => {
	...
	const titleProps = useSpring({
		...
		to: {
			...
			transform: ratio >= 0.1 ? `translate(0px, 0px)` : `translate(100px, 0px);`
		}
	});
	...
	const subtitleProps = useSpring({
		...
		to: {
			...
			transform: ratio >= 0.2 ? `translate(0px, 0px)` : `translate(100px, 0px);`
		}
	});
	...
	const descriptionProps = useSpring({
		...
		to: {
			...
			transform: ratio >= 0.3 ? `translate(0px, 0px)` : `translate(100px, 0px);`
		}
	});
