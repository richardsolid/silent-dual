                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">Niet-Residentiële ventilatie-units​</p>",
                            font: ['roboto', [14, "px"], "rgba(255,255,255,1.00)", "400", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'unidades-ex-nores',
                            type: 'text',
                            rect: ['260px', '132px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; font-family: roboto; font-weight: 400; font-style: normal; text-decoration: none; font-size: 12px; color: rgb(50, 153, 204); background-color: rgba(0, 0, 0, 0); letter-spacing: 0px; text-transform: none; word-spacing: 0px; text-align: start; text-indent: 0px; line-height: normal;\">Zie uitgesloten units​</p>",
                        ...
                        },
                        {
                            id: 'Text01Copy3',
                            type: 'text',
                            rect: ['34px', '182px', 'auto', 'auto', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\"></p><p style=\"margin: 0px;\">Residentiële ventilatie-units​</p>",
                            align: "center",
                            font: ['roboto', [14, "px"], "rgba(255,255,255,1.00)", "400", "none", "", "break-word", "nowrap"]
                        },
                        {
