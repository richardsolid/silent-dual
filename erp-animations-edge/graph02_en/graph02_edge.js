                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'txt01-left',
                            type: 'text',
                            rect: ['70px', '81px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: right;\">​MANUFACTURER</p>",
                        ...
                        },
                        {
                            ...
                            c: [
                            {
                                ...
                                text: "<p style=\"margin: 0px;\">​MODEL CLASS</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            },
                            {
                                id: 'txt02-rightCopy',
                                ...
                                text: "<p style=\"margin: 0px;\">​(According to a</p><p style=\"margin: 0px;\">medium weather)</p>",
                        ...
                        },
                        {
                            id: 'txt02-left',
                            type: 'text',
                            rect: ['82px', '421px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​LwA: RADIATED</p><p style=\"margin: 0px;\">SOUND FROM</p><p style=\"margin: 0px;\">THE BOX (dB)</p>",
                            align: "right",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​MAXIMUM AIR FLOW</p><p style=\"margin: 0px;\">​AT ​100Pa</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'Group3',
                            ...
                            c: [
                            {
                                ...
                                c: [
                                {
                                    ...
                                    type: 'text',
                                    rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                    text: "<p style=\"margin: 0px;\">​Single flow</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'txt02-rightCopy3',
                                    type: 'text',
                                    rect: ['0px', '23px', 'auto', 'auto', 'auto', 'auto'],
                                    text: "<p style=\"margin: 0px;\">​Double flow</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'arrow',
                            ...
                            },
                            {
                                ...
                                type: 'text',
                                rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\">SYSTEM TYPE</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            }]
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">REFERENCE</p><p style=\"margin: 0px;\">​PERIOD</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        }
                    ],
                    style: {
