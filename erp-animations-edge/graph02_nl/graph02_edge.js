                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'txt01-left',
                            type: 'text',
                            rect: ['100px', '81px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: right;\">​PRODUCENT</p>",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​MODEL</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'line01Copy',
                        ...
                        },
                        {
                            ...
                            c: [
                            {
                                ...
                                text: "<p style=\"margin: 0px;\">​MODELKLASSE&nbsp;</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            },
                            {
                                id: 'txt02-rightCopy',
                                ...
                                text: "<p style=\"margin: 0px;\">​(VOOR EEN GEMATIGD</p><p style=\"margin: 0px;\">​KLIMAAT)</p><p style=\"margin: 0px;\"></p>",
                        ...
                        },
                        {
                            id: 'txt02-left',
                            type: 'text',
                            rect: ['12px', '412px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​LWA: HET DOOR DE</p><p style=\"margin: 0px;\">KAST AFGEGEVEN</p><p style=\"margin: 0px;\">​GELUIDSVERMOGEN IN dB</p><p style=\"margin: 0px;\"></p><p style=\"margin: 0px;\"></p>",
                            align: "right",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​MAXIMALE LUCHTSTROOM</p><p style=\"margin: 0px;\">BIJ 100 Pa</p><p style=\"margin: 0px;\"></p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'Group3',
                            ...
                            c: [
                            {
                                ...
                                c: [
                                {
                                    ...
                                    type: 'text',
                                    rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                    text: "<p style=\"margin: 0px;\">​ENKELE LUCHTSTROOM</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'txt02-rightCopy3',
                                    type: 'text',
                                    rect: ['0px', '23px', 'auto', 'auto', 'auto', 'auto'],
                                    text: "<p style=\"margin: 0px;\">​DUBBELE LUCHTSTROOM</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'arrow',
                                    type: 'image',
                                    rect: ['149px', '1px', '12px', '12px', 'auto', 'auto'],
                                    fill: ["rgba(0,0,0,0)",im+"arrow.png",'0px','0px']
                                },
                                {
                                    id: 'arrowCopy',
                                    type: 'image',
                                    rect: ['149px', '24px', '12px', '12px', 'auto', 'auto'],
                                    fill: ["rgba(0,0,0,0)",im+"arrow.png",'0px','0px']
                                },
                                {
                                    id: 'arrowCopy2',
                                    type: 'image',
                                    rect: ['166px', '25px', '12px', '12px', 'auto', 'auto'],
                                    fill: ["rgba(0,0,0,0)",im+"arrow.png",'0px','0px'],
                                    transform: [[],['180']]
                                }]
                            },
                            {
                                ...
                                type: 'text',
                                rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\">SYSTEEMTYPE​</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            }]
                        },
                        {
                            id: 'txt05-right',
                            type: 'text',
                            rect: ['758px', '564px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\"></p><p style=\"margin: 0px;\">REFERENTIEPERIODE​</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        }
                    ],
                    style: {
