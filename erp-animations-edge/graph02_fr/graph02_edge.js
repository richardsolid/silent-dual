                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'txt01-left',
                            type: 'text',
                            rect: ['107px', '81px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: right;\">​FABRICANT</p>",
                        ...
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​MODELE</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'line01Copy',
                        ...
                        },
                        {
                            id: 'Group2',
                            type: 'group',
                            rect: ['758px', '167px', '123', '55', 'auto', 'auto'],
                            opacity: '0',
                            c: [
                            {
                                id: 'txt02-right',
                                ...
                                text: "<p style=\"margin: 0px;\">​CLASSIFICATION</p><p style=\"margin: 0px;\">ENERGETIQUE</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            },
                            {
                                id: 'txt02-rightCopy',
                                ...
                                text: "<p style=\"margin: 0px;\">​(Correspondant à un</p><p style=\"margin: 0px;\">climat moyen)</p>",
                        ...
                        },
                        {
                            id: 'txt02-left',
                            type: 'text',
                            rect: ['74px', '431px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​LwA:PUISSANCE</p><p style=\"margin: 0px;\">ACOUSTIQUE</p><p style=\"margin: 0px;\">RAYONNÉE (dB)&nbsp;</p><p style=\"margin: 0px;\"></p>",
                            align: "right",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">​DÉBIT MAXIMAL</p><p style=\"margin: 0px;\"> ​À 100Pa</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'Group3',
                            ...
                            c: [
                            {
                                ...
                                c: [
                                {
                                    ...
                                    type: 'text',
                                    rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                    text: "<p style=\"margin: 0px;\">​Simple flux</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'txt02-rightCopy3',
                                    ...
                                    text: "<p style=\"margin: 0px;\">​Double flux</p>",
                                    font: ['roboto', [12, "px"], "rgba(102,102,102,1.00)", "400", "none", "", "break-word", "nowrap"]
                                },
                                {
                                    id: 'arrow',
                            ...
                            },
                            {
                                ...
                                type: 'text',
                                rect: ['0px', '0px', 'auto', 'auto', 'auto', 'auto'],
                                text: "<p style=\"margin: 0px;\">TYPE D'INSTALLATION</p>",
                                font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                            }]
                        },
                        {
                            ...
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">PÉRIODE DE</p><p style=\"margin: 0px;\">RÉFÉRENCE</p>",
                            font: ['roboto', [14, "px"], "rgba(51,51,51,1.00)", "500", "none", "", "break-word", "nowrap"]
                        }
                    ],
                    style: {
