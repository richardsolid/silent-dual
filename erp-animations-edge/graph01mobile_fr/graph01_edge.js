                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text01Copy2',
                            type: 'text',
                            rect: ['95px', '85px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">Unités de ventilation non résidentielles​</p>",
                            font: ['roboto', [14, "px"], "rgba(255,255,255,1.00)", "400", "none", "", "break-word", "nowrap"]
                        },
                        {
                            id: 'unidades-ex-nores',
                            type: 'text',
                            rect: ['270px', '132px', 'auto', 'auto', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px;\">voir les exclusions​</p>",
                        ...
                        },
                        {
                            ...
                            text: "<p style=\"margin: 0px;\">Unités de ventilation</p><p style=\"margin: 0px;\">résidentielles​</p>",
                            align: "center",
                            font: ['roboto', [14, "px"], "rgba(255,255,255,1.00)", "400", "none", "", "break-word", "nowrap"]
                        },
                        {
