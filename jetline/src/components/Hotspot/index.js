...
function Hotspot({
  ...
  return(
    <div
      ...
      className={`absolute flex flex-col items-center ${isOpen ? "z-10" : "z-0"}`}
    >
      ...
      >
        ...
        <svg className="text-white h-4" x="0px" y="0px" viewBox="0 0 255 255" ><polygon className="fill-current" points="0,0 127.5,127.5 255,0"/></svg>
      </animated.div>
      )}
