...
export default function Installation({
  ...
  return(
    <div id="installation" className="w-full py-24 bg-white px-5 lg:px-0">
      <animated.div style={props} ref={ref} className="flex flex-col max-w-screen-lg mx-auto items-center">
      ...
      <div className="flex flex-col max-w-screen-lg mx-auto">
        <div>
          ...
          <InstallationItem data={data.items[1]} image={images[1]} reverse={true}/>
